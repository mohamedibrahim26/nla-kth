...
3. Switch the target to a code model like `Qwen2.5-Coder-0.5B` and ask whether the verbalizer flags buggy versus correct lines. This direction connects directly to the ASSERT lab's AI4Code focus.
